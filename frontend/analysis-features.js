...
function init(){
 ...
 const row=document.querySelector('[data-paste-spreadsheet]').parentElement,del=document.body.classList.contains('classic')&&row.querySelector('[data-action="dataset-remove"]');
 if(del)row.insertBefore(btn,del);else row.append(btn);
